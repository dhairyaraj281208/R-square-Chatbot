...
model = load_model("D:\\R square\\Backend Prototype\\chatbot_model.h5")

data = pickle.load(open('D:\\R square\\Backend Prototype\\training_data.pkl', 'rb'))
words = data['words']
